...
data  = dict(eng = {}, nld = {}, deu = {}, fra = {}, spa = {}, jpn = {})
out   = {}

for lang in "eng nld deu fra spa jpn".split():
...
with open("links.csv") as f:
  for line in f:
    ...
    out.setdefault(a, {})
    for lang in "eng nld deu fra spa".split():
...
for i, x in out.items():
  rest = ( x.get(k) or "-" for k in "eng nld deu fra spa audio".split() )
